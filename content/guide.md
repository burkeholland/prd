...
The sample PRD was not written in one sitting: it went through more than a dozen revisions in its first three weeks, and its biggest revision cut far more than it added. [See how it evolved](/history) — what grew, what was rewritten, and when.
